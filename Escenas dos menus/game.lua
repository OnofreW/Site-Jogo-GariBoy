...
function scene:create( event )
	...
	local bg1 = display.newImageRect (backGroup, "imagens/city.png", 1090, 770)
...
for i = 0,1 do 
	local chao = display.newRect (mainGroup, 0, 600, 1000000000, 600 )
...
for i = 0, 9 do 
	local acido = display.newImageRect (mainGroup, "imagens/acido.png", 150 , 200 )
	acido.x = -200+(128*i)
	acido.y = 220
	camera:add (acido, 1) 
...
for i =  0 ,1 do 
	local nivel1 = display.newImageRect (mainGroup, "imagens/nivel1.png", 200 , 200 )
 	nivel1.x =  500
 	nivel1.y = -50
 	camera:add ( nivel1, 1)
...
for i = 0, 1 do 
	local nivel2 = display.newImageRect (mainGroup, "imagens/nivel2.png", 200, 200 )
	nivel2.x = 4900
	nivel2.y = -280
	camera:add (nivel2, 1 )
end 
...
for i = 0, 1 do 
	local nivel3 = display.newImageRect (mainGroup, "imagens/nivel3.png", 200, 200)
	nivel3.x = 9300
	nivel3.y = -420
	camera:add (nivel3, 1)
end 
...
for i = 0 , 1 do 
	local lixoFinal = display.newImageRect (mainGroup, "imagens/lixeiraPapel.png" , 200 , 150 )
	lixoFinal.x = 14100
	lixoFinal.y = -400 
...
for i = 0, 3 do 
	local plataforma1 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130, 130)
...
for i = 0, 5 do
	local plataforma2 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130, 130 )
...
for i = 0, 1 do
	local plataforma3 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130, 130)
	plataforma3.x = 800
	plataforma3.y = 700
...
for i = 0, 2 do 
	local plataforma4  = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130,130 )
...
for i = 0, 2 do 
	local plataforma5  = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130,130 )
...
for i = 0, 2 do 
	local plataforma6 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130)
...
for i = 0, 3 do 
	local plataforma7 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130, 130)
...
for i = 0, 2 do 
	local plataforma8 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130 )
...
for i = 0, 2 do 
	local plataforma9 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 ,130 )
...
for i = 0, 3 do 
	local plataforma10 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 ,130 )
...
for i = 0, 2 do 
	local plataforma11 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 ,130)
...
for i = 0, 2 do 
	local plataforma12 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130 )
...
for i = 0, 4 do 
	local plataforma13 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130 )
...
for i = 0, 7 do 
	local plataforma14 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130 )
...
for i = 0, 3 do 
	plataforma15 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130 )
...
for i = 0, 5 do 
	plataforma16 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130 )
...
for i = 0, 5  do 
	local espinhos = display.newImageRect (mainGroup, "imagens/espinhos.png", 100, 100 )
	espinhos.x = 10200
	espinhos.y = -385
...
for i = 0, 7 do 
	plataforma17 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130 )
...
for i = 0, 5 do 
	plataforma18 = display.newImageRect (mainGroup, "imagens/plataforma1.png", 130 , 130 )
...
for i = 0, 5  do 
 ...
 for i = 0, 1 do 
	local caixa1 = display.newImageRect (mainGroup, "imagens/caixa.png", 110, 110 )
	caixa1.x = 11400
	caixa1.y = -390
	camera:add (caixa1, 1)
...
for i = 0, 1 do 
	local caixa2 = display.newImageRect (mainGroup, "imagens/caixa.png" , 110 , 110)
	caixa2.x = 8555
	caixa2.y = -390
	camera:add (caixa2, 1)
...
for i = 0, 1 do 
	local espinhos = display.newImageRect (mainGroup, "imagens/espinhos.png", 90, 90 )
	espinhos.x = 8458
	espinhos.y = -390 
	espinhos.rotation = 270
	camera:add (espinhos , 1)
...
for i = 0, 1 do 
	local espinhos = display.newImageRect (mainGroup, "imagens/espinhos.png", 80, 80 )
...
for i = 0 , 1 do 
	local espinhos = display.newImageRect (mainGroup, "imagens/espinhos.png", 90, 100)
	espinhos.x = 8080
	espinhos.y = -380
	camera:add (espinhos, 1)
	physics.addBody (espinhos, "static", {radius=30})
...
for i = 0, 4 do 
    local lixo = display.newImageRect (mainGroup, "imagens/cinza.png", 60, 60)
	lixo.x = 950 + (128*i)
	lixo.y = -144
	camera:add (lixo, 1)
...
for i = 0, 1 do 
	local lixo = display.newImageRect (mainGroup, "imagens/amarelo.png", 60, 60)
	lixo.x = 5500
	lixo.y = -345
	camera:add (lixo, 1)
	physics.addBody (lixo, "static", {radius=25 })
...
for i = 0, 1 do 
	local lixo = display.newImageRect (mainGroup, "imagens/azul.png", 60, 60)
	lixo.x = 9560 + (128*i)
	lixo.y = -360
	camera:add (lixo, 1)
	physics.addBody (lixo, "static", {radius=25 })
...
for i = 0, 1 do 
    ...
    playerScript.novo (mainGroup, 240, 0)
    camera:add (player, 1)

    monstroScript.novo (mainGroup, -150, 0)
...
-- Alteração decrescente para cada layer.
    ...
    pontosText = display.newText (uiGroup, "Pontos: " .. pontos, 200, 80, native.systemFont, 36) 
    vidasText = display.newText (uiGroup, "Vidas: " .. vidas, 400, 80, native.systemFont, 36) 

    player:addEventListener ("touch", pular )

    audioFundo1 = audio.loadStream ("audio/fundo1.mp3")
    audioPontos1 = audio.loadSound ("audio/pontos1.mp3")
    audioPulo1 = audio.loadSound ("audio/pulo1.mp3")
...
function scene:hide( event )
	...
	elseif ( phase == "did" ) then
		...
		Runtime:removeEventListener ("collision", onCollision3)
        Runtime:removeEventListener ("collision", onCollision4) 
		physics.pause()
		audio.stop(1)
		audio.stop(2)
